...
public interface SRWPort extends java.rmi.Remote {
    ...
    public gov.loc.www.zing.srw.utils.Stream searchRetrieveOperation(de.escidoc.core.domain.sru.SearchRetrieveRequestType body, org.apache.axis.MessageContext msgContext, String handle) throws java.rmi.RemoteException;
