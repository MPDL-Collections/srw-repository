...
public class SRWSoapBindingStub extends org.apache.axis.client.Stub implements gov.loc.www.zing.srw.interfaces.SRWPort {
    ...
    private static void _initOperationDesc1(){
        ...
        oper.setName("SearchRetrieveOperation");
        ...
        oper.setReturnQName(new javax.xml.namespace.QName("http://www.loc.gov/zing/srw/", "searchRetrieveResponse"));
        oper.setStyle(org.apache.axis.constants.Style.DOCUMENT);
        oper.setUse(org.apache.axis.constants.Use.LITERAL);
        _operations[0] = oper;

        oper = new org.apache.axis.description.OperationDesc();
        oper.setName("ScanOperation");
        param = new org.apache.axis.description.ParameterDesc(new javax.xml.namespace.QName("http://www.loc.gov/zing/srw/", "scanRequest"), org.apache.axis.description.ParameterDesc.IN, new javax.xml.namespace.QName("http://www.loc.gov/zing/srw/", "scanRequestType"), gov.loc.www.zing.srw.ScanRequestType.class, false, false);
        oper.addParameter(param);
        oper.setReturnType(new javax.xml.namespace.QName("http://www.loc.gov/zing/srw/", "scanResponseType"));
        oper.setReturnClass(gov.loc.www.zing.srw.ScanResponseType.class);
        oper.setReturnQName(new javax.xml.namespace.QName("http://www.loc.gov/zing/srw/", "scanResponse"));
        oper.setStyle(org.apache.axis.constants.Style.DOCUMENT);
        oper.setUse(org.apache.axis.constants.Use.LITERAL);
        _operations[1] = oper;
    ...
    public SRWSoapBindingStub() throws org.apache.axis.AxisFault {
         this(null);
    }

    public SRWSoapBindingStub(java.net.URL endpointURL, javax.xml.rpc.Service service) throws org.apache.axis.AxisFault {
         this(service);
         super.cachedEndpoint = endpointURL;
    }

    public SRWSoapBindingStub(javax.xml.rpc.Service service) throws org.apache.axis.AxisFault {
        if (service == null) {
 ...
 try {        java.lang.Object _resp = _call.invoke(new java.lang.Object[] {body});
  ...
  throw axisFaultException;
    ...
    public gov.loc.www.zing.srw.ScanResponseType scanOperation(gov.loc.www.zing.srw.ScanRequestType body) throws java.rmi.RemoteException {
        ...
        _call.setProperty(org.apache.axis.AxisEngine.PROP_DOMULTIREFS, Boolean.FALSE);
        _call.setSOAPVersion(org.apache.axis.soap.SOAPConstants.SOAP11_CONSTANTS);
        _call.setOperationName(new javax.xml.namespace.QName("", "ScanOperation"));
 ...
 try {        java.lang.Object _resp = _call.invoke(new java.lang.Object[] {body});
        ...
        if (_resp instanceof java.rmi.RemoteException) {
            ...
            extractAttachments(_call);
            try {
                return (gov.loc.www.zing.srw.ScanResponseType) _resp;
            } catch (java.lang.Exception _exception) {
                return (gov.loc.www.zing.srw.ScanResponseType) org.apache.axis.utils.JavaUtils.convert(_resp, gov.loc.www.zing.srw.ScanResponseType.class);
            }
        }
  } catch (org.apache.axis.AxisFault axisFaultException) {
  throw axisFaultException;
